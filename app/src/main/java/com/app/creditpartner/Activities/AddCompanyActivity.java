...
public class AddCompanyActivity extends AppCompatActivity {
    ...
    public String currentUSerID,ref,email,phoneNumber,feature="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        features.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra( "companyFeatures", feature);
...
//                productID.setText(dataSnapshot.child("productID").getValue().toString());
                ...
                feature=dataSnapshot.child("companyFeatures").getValue().toString();
    ...
    private void SetKnownDetails() {
        ...
        Ref.child("Customers").child("BasicInfo").child(currentUSerID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(ref.isEmpty()){
                    murl="https://primeindia.o18.link/c?o="+productID.getText().toString()+"&m=2606&a=74725&sub_aff_id="+phoneNumber;

                }else{
                    murl="https://primeindia.o18.link/c?o="+productID.getText().toString()+"&m=2606&a="+ref+"&sub_aff_id="+phoneNumber;
                }
