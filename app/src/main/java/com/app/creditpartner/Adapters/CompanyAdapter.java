...
import com.app.creditpartner.Activities.AddCompanyActivity;
import com.app.creditpartner.R;
import com.bumptech.glide.Glide;
import com.app.creditpartner.Activities.ApplyFormActivity;
import com.app.creditpartner.Classes.Companies;
    ...
    public void onBindViewHolder(@NonNull final CompanyAdapter.ViewHolder holder, int position) {
     ...
     /*   holder.dragButton.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                Ref.child("CompanyList").child(productName).addValueEventListener(new ValueEventListener() {
                    @Override
